...
public class PendingTransactionAdapter extends RecyclerView.Adapter<PendingTransactionAdapter.RecyclerViewHolder> {

    private List<Orders> orders = new ArrayList<>();
    private Context context;

    public PendingTransactionAdapter(List<Orders> orders, Context context) {
        this.orders = orders;
